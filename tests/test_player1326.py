...
def test_one_win_determine_bets(player1326_regular):
    ...
    assert player1326_regular._determine_bets()[0].amount_bet == player1326_regular.base_bet_amount * 3


def test_two_wins_determine_bets(player1326_regular):
    player1326_regular.win(player1326_regular._determine_bets()[0])
    player1326_regular.win(player1326_regular._determine_bets()[0])
    assert player1326_regular._determine_bets()[0].amount_bet == player1326_regular.base_bet_amount * 2
...
def test_three_wins_determine_bets(player1326_regular):
    ...
    player1326_regular.win(player1326_regular._determine_bets()[0])
    player1326_regular.win(player1326_regular._determine_bets()[0])
    assert player1326_regular._determine_bets()[0].amount_bet == player1326_regular.base_bet_amount * 6
...
def test_four_wins_determine_bets(player1326_regular):
    ...
    player1326_regular.win(player1326_regular._determine_bets()[0])
    player1326_regular.win(player1326_regular._determine_bets()[0])
    assert player1326_regular._determine_bets()[0].amount_bet == player1326_regular.base_bet_amount
